...
void GameMusic::play_next()
{
}

GameMusic::GameMusic(SDL2pp::Mixer &mixer) : paths({MUSIC_ONE_PATH, MUSIC_TWO_PATH, MUSIC_THREE_PATH}),
                                             mixer(mixer), current_index(0)
{
}

void GameMusic::start(unsigned volume)
{
