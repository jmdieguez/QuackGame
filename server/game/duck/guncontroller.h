...
public:
    ...
    void drop_grenade(DuckStatus &status, std::vector<std::shared_ptr<Projectile>> &projectiles);
    void drop_banana(DuckStatus &status, std::vector<std::shared_ptr<Projectile>> &projectiles);
